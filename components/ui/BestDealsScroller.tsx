...
export default function BestDealsScroller() {
  ...
  // Fetch best deal properties
  useEffect(() => {
    const fetchBestDeals = async () => {
      try {
        const response = await fetch("/api/properties?bestDeal=true&limit=12");
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Grab these amazing deals before they're gone!</p>
          </div>
          <a
            href="/properties"
