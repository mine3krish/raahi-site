          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {activeTab === "contact" && (
              <div className="space-y-6">
                ...
                {/* WAHA Configuration for Mobile Login OTP */}
                <div className="mt-8 pt-8 border-t">
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">
                    📱 WhatsApp OTP Configuration (WAHA)
                  </h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Configure WAHA to send OTP via WhatsApp for mobile login/signup
                  </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={settings.wahaBaseUrl || ""}
                        onChange={(e) => setSettings({ ...settings, wahaBaseUrl: e.target.value })}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={settings.wahaSessionName || ""}
                        onChange={(e) => setSettings({ ...settings, wahaSessionName: e.target.value })}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                        placeholder="default"
                      />
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="url" value={settings.youtubeUrl} onChange={(e) => setSettings({ ...settings, youtubeUrl: e.target.value })} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="https://youtube.com/..." />
                  </div>
                  <div>
